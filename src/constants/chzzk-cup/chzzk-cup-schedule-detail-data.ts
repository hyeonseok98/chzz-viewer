...
const OFFICIAL_SCRIMS: ChzzkCupMatch[] = [
  ...
  // 11/27 (목) TIME4 02:00 ~ 02:00(추가 비공개스크림)
  {
    id: "UNOFFICIAL_2025-11-27_SOURF_GANGMOM_BO3",
    stageId: "UNOFFICIAL_SCRIM",
    dateKey: "2025-11-27",
    dateLabel: "11/27 (목)",
    timeLabel: "02:00 ~ 03:30",
    timeKey: "26:00_1",
    seriesType: "BO3",
    leftTeamId: "SOURF",
    rightTeamId: "GANGMOM",
  ...
  {
    id: "UNOFFICIAL_2025-11-27_WOLF_CUVEE_BO3",
    stageId: "UNOFFICIAL_SCRIM",
    dateKey: "2025-11-27",
    dateLabel: "11/27 (목)",
